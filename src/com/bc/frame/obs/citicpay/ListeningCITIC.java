package com.bc.frame.obs.citicpay;
 ...
 *中信监听服务
 */
public class ListeningCITIC extends AbsObserver implements MessageListener{

    private static Log log = LogFactory.getLog(ListeningCITIC.class);
